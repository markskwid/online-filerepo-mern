...
import Retrieve from "../imports/retrive_modal";
...
const Archive = () => {
  ...
  const [arcFile, setArcFile] = useState("");
  const [retrieveModal, setRetrieveVisible] = useState(false);
  ...
  }, [currentPath, moveFileName, renameModal, alert, arcFile]);
  ...
  const getArea = async () => {
    const res = await axios.post("/api/get-archive", {
              ...
              <ul className="dropdown-menu">
                <li>
                  <button
                    ...
                    onClick={() => setArcFile(item) || setRetrieveVisible(true)}
                  >
                    {" "}
                    Retrieve
                  </button>
        ...
        >
          ...
          <ul className="dropdown-menu">
            <li>
              <button
                className="dropdown-item bg-transparent"
                onClick={() => setRetrieveVisible(true) || setArcFile(item)}
              >
                {" "}
                Retrieve
              </button>
  ...
  const toggleModal = () => {
    setRetrieveVisible(!retrieveModal);
  };
  ...
  return (
    <div className="container-fluid">
      ...
      <Retrieve isOpen={retrieveModal} fileName={arcFile} toggle={toggleModal} />
    </div>
  );
};
